...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            org.opencv.imgcodecs.Imgcodecs.imwrite("output.jpg", result);
            System.out.println("✅ Hoàn tất! Đã lưu output.jpg.");


            org.opencv.highgui.HighGui.imshow("KẾT QUẢ PHÁT HIỆN KHẨU TRANG", result);
            org.opencv.highgui.HighGui.waitKey(0); // Chờ người dùng bấm phím bất kỳ để đóng ảnh


            int coKhauTrang = faceCount;
            int khongKhauTrang = 0;

            ui.updateStatisticsData(coKhauTrang, khongKhauTrang);
